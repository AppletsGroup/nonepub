...
export class TodoItemNodeView implements NodeView {
  ...
  constructor(
    ...
    this.dom.className = 'xx-editor-todo-item flex items-start py-1'
    ...
    checkboxContainer.className =
      'w-5 h-5 flex items-center justify-center mr-1 flex-shrink-0'
    checkboxContainer.appendChild(checkbox)

    const content = document.createElement('div')
    content.className = 'flex-auto whitespace-pre-wrap text-sm'
